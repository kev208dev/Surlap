...
const Map<String, Map<AppLang, String>> kTranslations = {
  ...
  '홈': {AppLang.en: 'Home', AppLang.ja: 'ホーム', AppLang.zh: '主页', AppLang.es: 'Inicio'},
  '캘린더': {AppLang.en: 'Calendar', AppLang.ja: 'カレンダー', AppLang.zh: '日历', AppLang.es: 'Calendario'},
  '스케줄': {AppLang.en: 'Schedule', AppLang.ja: 'スケジュール', AppLang.zh: '课程表', AppLang.es: 'Horario'},
