...
| 항목 | 값 |
|---|---|
| URL | `https://ngmvddxpoqtbrwpwiogh.supabase.co/functions/v1/account-delete-request` |
...
| 데이터 수집 | 예(§6.2) |
| 전송 중 암호화 | 예 |
| 데이터 삭제 URL | `https://ngmvddxpoqtbrwpwiogh.supabase.co/functions/v1/account-delete-request` |
| 정부 앱 | 아니요 |
| 금융 기능 | 아니요 |
| 건강 | 아니요 |
